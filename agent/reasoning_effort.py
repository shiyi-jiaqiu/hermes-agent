...
# Gemini 3.x thinking-level vocabularies used by the native and Responses-compatible
# transports. Gemini 2.5 is intentionally omitted because it uses numeric thinkingBudget.
GEMINI_3_8_3_7_FLASH_EFFORTS: tuple[str, ...] = ("low", "medium", "high")
GEMINI_3_6_3_5_FLASH_EFFORTS: tuple[str, ...] = ("minimal", "low", "medium", "high")
GEMINI_3_1_PRO_EFFORTS: tuple[str, ...] = ("low", "medium", "high")
GEMINI_3_1_FLASH_LITE_IMAGE_EFFORTS: tuple[str, ...] = ("minimal", "high")
GEMINI_3_FLASH_LITE_EFFORTS: tuple[str, ...] = ("minimal", "low", "medium", "high")
GEMINI_3_PRO_EFFORTS: tuple[str, ...] = ("low", "high")
GEMINI_3_FLASH_EFFORTS: tuple[str, ...] = ("minimal", "low", "medium", "high")


def gemini_supported_efforts(model: Optional[str]) -> Optional[tuple[str, ...]]:
    """Return the documented Gemini 3 thinking-level vocabulary, or None when not applicable."""
