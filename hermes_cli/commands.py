...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("context", "Show detailed context window view with usage gauge, category breakdown, compression stats, and throughput", "Session",
               ...
               busy_policy="dispatch"),
    CommandDef("panel", "Open the Feishu interactive control panel", "Session",
               gateway_only=True,
               args_hint="[model|reasoning|sessions|status]",
               subcommands=("model", "reasoning", "sessions", "status"),
               busy_policy="dispatch"),
    ...
    CommandDef("mode", "Apply a configured model/reasoning mode; add 'fast' for Fast mode",
               "Configuration", aliases=("quick", "daily", "deep"),
               args_hint="<quick|daily|deep> [fast]",
               subcommands=("quick", "daily", "deep"),
               busy_policy="reject", busy_handler="model", desktop="hidden"),
